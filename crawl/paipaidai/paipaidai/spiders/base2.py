...
class PaipaidaiSpider(CrawlSpider):
    ...
    url1 = ['http://www.ppdai.com/lend/12_s0_p'+str(x) for x in range(3,5)] #热投区
    url2 = ['http://www.ppdai.com/lend/13_s0_p'+str(x) for x in range(3,5)] #安全标专区
    url3 = ['http://www.ppdai.com/lend/14_s0_p'+str(x) for x in range(3,5)] #逾期就赔
    url4 = ['http://www.ppdai.com/lend/8_s0_p'+str(x) for x in range(3,5)]  #网商专区
    url5 = ['http://www.ppdai.com/lend/3_s0_p'+str(x) for x in range(3,5)]  #二次借款
    url6 = ['http://www.ppdai.com/lend/15_s0_p'+str(x) for x in range(3,5)] #合作机构专区
    url7 = ['http://www.ppdai.com/lend/16_s0_p'+str(x) for x in range(3,5)] #新手福利标
    url1.extend(url2)
    url1.extend(url3)
    url1.extend(url4)
    url1.extend(url5)
